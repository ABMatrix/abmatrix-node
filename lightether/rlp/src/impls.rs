...
#[cfg(not(feature = "std"))] use core::{mem, str};
#[cfg(feature = "std")] use std::iter::{once, empty};
#[cfg(not(feature = "std"))] use core::iter::{once, empty};
...
#[cfg(not(feature = "std"))]
use core::cmp;
use primitives::{U128, U256, H64, H128, H160, H256, H512, H520, Bloom};
